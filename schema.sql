...
('Charlotte''s Web', 'E.B. White', 'Children', 1952, 'A pig and a spider form a touching friendship.', 4.5, 190, 'https://covers.openlibrary.org/b/isbn/9780064410939-L.jpg'),
...
('The Adventures of Sherlock Holmes', 'Arthur Conan Doyle', 'Mystery', 1892, 'A collection of Holmes''s most famous cases.', 4.8, 350, 'https://covers.openlibrary.org/b/isbn/0895772779-L.jpg'),
...
('God Emperor of Dune', 'Frank Herbert', 'Science Fiction', 1981, 'Leto II rules the galaxy as a tyrant to ensure humanity''s survival.', 4.2, 280, 'https://covers.openlibrary.org/b/isbn/9780441294671-L.jpg'),
